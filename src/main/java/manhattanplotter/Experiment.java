...
public class Experiment{
    ...
    public static final int MANHATTAN_EXPERIMENT = 1;
    static final int NO_POSITION_EXPERIMENT = 2;   // doesn't have to include
                                                    // chromosome and position

    public Test[] tests;
    public GenomeInfo genomeInfo = new GenomeInfo();
    public Boolean genomeInfoOK = true;
    public ArrayList<Test> testsArray = new ArrayList<Test>();
    public double maxLogPValue = 0;
    public int experimentType = MANHATTAN_EXPERIMENT;
